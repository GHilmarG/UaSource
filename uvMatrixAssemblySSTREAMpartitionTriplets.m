...
if ~Ronly
    ...
    iK=zeros(MUA.nod*MUA.nod*MUA.Nele*4,1);
    jK=zeros(MUA.nod*MUA.nod*MUA.Nele*4,1);
    Kval=zeros(MUA.nod*MUA.nod*MUA.Nele*4,1);
    istak=0;
    ...
    for Inod=1:MUA.nod
        ...
        for Jnod=1:MUA.nod
            ...
            iK(istak+1:istak+MUA.Nele)=MUA.connectivity(:,Inod); jK(istak+1:istak+MUA.Nele)=MUA.connectivity(:,Jnod); Kval(istak+1:istak+MUA.Nele)=d1d1(:,Inod,Jnod);
            istak=istak+MUA.Nele;

            iK(istak+1:istak+MUA.Nele)=MUA.connectivity(:,Inod)+neqx; jK(istak+1:istak+MUA.Nele)=MUA.connectivity(:,Jnod)+neqx; Kval(istak+1:istak+MUA.Nele)=d2d2(:,Inod,Jnod);
            istak=istak+MUA.Nele;

            iK(istak+1:istak+MUA.Nele)=MUA.connectivity(:,Inod); jK(istak+1:istak+MUA.Nele)=MUA.connectivity(:,Jnod)+neqx; Kval(istak+1:istak+MUA.Nele)=d1d2(:,Inod,Jnod);
            istak=istak+MUA.Nele;

            iK(istak+1:istak+MUA.Nele)=MUA.connectivity(:,Inod)+neqx; jK(istak+1:istak+MUA.Nele)=MUA.connectivity(:,Jnod); Kval(istak+1:istak+MUA.Nele)=d2d1(:,Inod,Jnod);
