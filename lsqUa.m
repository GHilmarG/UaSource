...
switch Algorithm
    ...
    case "LevenbergMarquardt"
        ...
        [x,lambda,R2,g2,residual,g,h,output] = lsqLevenbergMarquardtUa(CtrlVar,fun,x,lambda,L,c) ;


    case "DogLeg"


        [x,lambda,R2,g2,residual,g,h,output] = lsqDogLegUa(CtrlVar,fun,x,lambda,L,c) ;
