function [R,K,T,F]=KRTFuvhTest(u,v,h,S,B,u0,v0,h0,as,ab,dt,AGlen,n,C,m,coordinates,connectivity,nip,alpha,rho,rhow,g,MeshProp,CtrlVar)
	
    
    %save TestSave u v h S B u0 v0 h0 as ab dt AGlen n C m coordinates connectivity nip alpha rho rhow g CtrlVar
    %error('asdf')
