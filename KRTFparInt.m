function [K,R,T,F]=KRTFparInt(Iint,s,S,B,h,u,v,AGlen,n,C,m,FEmesh,alpha,rho,rhow,g,CtrlVar)
	               
	
coordinates=FEmesh.Coordinates;
connectivity=FEmesh.Connectivity;
Boundary=FEmesh.Boundary;
Nnodes=FEmesh.Nnodes;
Nele=FEmesh.Nele;
nod=FEmesh.Nod;
nip=FEmesh.Nip;

% just for testing some parallel features
