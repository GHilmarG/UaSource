...
if x1==x2
    ...
    % This is a parabolic minimum based on slope at x=x0=0 and the values
    % y=y(x0=0) and y1=y(x1) 
    

    xmin=-x1*Slope/2/( (y1-y0)/x1-Slope) ;
...
if ~isreal(xmin) ||isnan(xmin) || InfoLevel>10000
