function [r,ruv,rh,gamma,infovector,iarm,BacktrackInfo]=FindBestGamma2DuvhBacktrack...
        (CtrlVar,MUA,F0,r0,r1,ruv1,rh1,u,v,h,du,dv,dh,S,B,u0,v0,h0,L,lambda,dlambda,as0,ab0,as1,ab1,dudt,dvdt,dt,AGlen,n,C,m,alpha,rho,rhow,g)
    ...
    while ExtrapolationStep && iarm<=10
        ...
        if gammaTest > 1.1*gammac  %  suggests extrapolation and new gamma not too close to previous one
           ...
           [r,ruv,rh]=CalcCostFunctionNRuvh(CtrlVar,MUA,gamma,du,dv,dh,u,v,h,S,B,u0,v0,h0,as0,ab0,as1,ab1,dudt,dvdt,dt,AGlen,n,C,m,alpha,rho,rhow,g,F0,L,lambda,dlambda);
    ...
    if iarm==0 && r> 0.1*r0 && r> CtrlVar.NLtol
        ...
        [rTest,ruvTest,rhTest]=CalcCostFunctionNRuvh(CtrlVar,MUA,gammaTest,du,dv,dh,u,v,h,S,B,u0,v0,h0,as0,ab0,as1,ab1,dudt,dvdt,dt,AGlen,n,C,m,alpha,rho,rhow,g,F0,L,lambda,dlambda);
    ...
    elseif iarm==1 && r> 0.1*r0 && BacktrackInfo.gammaNaN==0;
        ...
        rTest=CalcCostFunctionNRuvh(CtrlVar,MUA,gammaTest,du,dv,dh,u,v,h,S,B,u0,v0,h0,as0,ab0,as1,ab1,dudt,dvdt,dt,AGlen,n,C,m,alpha,rho,rhow,g,F0,L,lambda,dlambda);
