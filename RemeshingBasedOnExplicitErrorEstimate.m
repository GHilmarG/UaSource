function [MUA,xGLmesh,yGLmesh,CtrlVar]=...
    RemeshingBasedOnExplicitErrorEstimate(MeshBoundaryCoordinates,S0,B0,h0,s0,b0,u0,v0,dhdt0,MUA,AGlen0,C0,n,rho0,rhow,CtrlVar,GF0)
...
[x0,y0,EleSize,EleSize0]=DesiredEleSizes(CtrlVar,MUA,s0,b0,S0,B0,rho0,rhow,u0,v0,dhdt0,h0,hf,AGlen0,n,GF0);
