...
function [p,UserVar,RunInfo]=UaOptimisationHessianBased(UserVar,CtrlVar,RunInfo,MUA,func,p0,plb,pub)

narginchk(8,8)


%% Does an inversion using the Hessian, as returned by JGH
%
...
while true
    ...
    if CtrlVar.Inverse.HessianOptions=="-FiniteDifferences-"
        ...
        % Here I just get the Hessian from JGH,
