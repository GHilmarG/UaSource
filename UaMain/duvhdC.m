...
function [KdudC,KdvdC,KdhdC,KdFuvhduvh]=duvhdC(CtrlVar,MUA,F,l,BCs,KdFuvhduvh,Nodes)
...
% then
%
% $$ \frac{\partial F^{uvh}_x}{\partial u} \; \frac{\partial u }{ \partial C}    +  \frac{\partial F^{uvh}_x}{\partial v} \; \frac{\partial v }{ \partial C} + \frac{\partial F^{uvh}_x}{\partial h} \; \frac{\partial h }{ \partial C} = - \frac{\partial F^{uvh}_x }{ \partial C}  $$
%
% $$ \frac{\partial F^{uvh}_y}{\partial u} \; \frac{\partial u }{ \partial C}    +  \frac{\partial F^{uvh}_y}{\partial v} \; \frac{\partial v }{ \partial C} + \frac{\partial F^{uvh}_y}{\partial h} \; \frac{\partial h }{ \partial C} = - \frac{\partial F^{uvh}_y }{ \partial C}  $$
%
% $$ \frac{\partial F^{uvh}_h}{\partial u} \; \frac{\partial u }{ \partial C}    +  \frac{\partial F^{uvh}_h}{\partial v} \; \frac{\partial v }{ \partial C} + \frac{\partial F^{uvh}}{\partial h} \; \frac{\partial h }{ \partial C} = - \frac{\partial F^{uvh}_h }{ \partial C}  $$
%
% or
%
% $$
...
% \end{array} \right )
% = - \left ( \begin{array}{c}
%   \frac{\partial F^{uvh}_x}{\partial C} \\
%   \frac{\partial F^{uvh}_y}{\partial C} \\
%   \frac{\partial F^{uvh}_h}{\partial C}
%   \end{array} \right )
% $$
%
%
...
KdFuvdC=dFuvdC(CtrlVar,MUA,F);   % this is sparse, and same derivative as dFuvhdC
KdFuvhdC=[KdFuvdC ; sparse(MUA.Nnodes,MUA.Nnodes)] ; 
