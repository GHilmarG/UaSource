...
function [Kdudh,Kdvdh,Kdhdh,KdFuvhduvh]=duvhdh(CtrlVar,MUA,F,l,BCs,KdFuvhduvh,Nodes)
...
%% Calculates the sensitivity matrix duvh/dh
%
%
% The $k$-column contains the response in u and v to a perturbation in $h_k$
%
%
% $$\left[\begin{array}{cccc}
% \partial u_1 /\partial h_1  & \partial u_1 /\partial h_2  & \ldots & \partial u_1 /\partial h_n  \\
% \partial u_2 /\partial h_1  & \partial u_2 /\partial h_2  & \ldots & \partial u_2 /\partial h_n  \\
%              .              &              .              &  .  &    .                          \\
% \partial v_1 /\partial h_1  & \partial v_1 /\partial h_2 & \ldots & \partial v_1 /\partial h_n  \\
% \partial v_2 /\partial h_1  & \partial v_2 /\partial h_2 & \ldots & \partial v_2 /\partial h_n  \\
%              .              &              .              &  .  &    .                          \\
% \end{array}\right] $$
%
% Approach:
...
% then
%
% $$ \frac{\partial F^{uvh}_x}{\partial u} \; \frac{\partial u }{ \partial h}    +  \frac{\partial F^{uvh}_x}{\partial v} \; \frac{\partial v }{ \partial h} + \frac{\partial F^{uvh}_x}{\partial h} \; \frac{\partial h }{ \partial h} = - \frac{\partial F^{uvh}_x }{ \partial h}  $$
%
% $$ \frac{\partial F^{uvh}_y}{\partial u} \; \frac{\partial u }{ \partial h}    +  \frac{\partial F^{uvh}_y}{\partial v} \; \frac{\partial v }{ \partial h} + \frac{\partial F^{uvh}_y}{\partial h} \; \frac{\partial h }{ \partial h} = - \frac{\partial F^{uvh}_y }{ \partial h}  $$
%
% $$ \frac{\partial F^{uvh}_h}{\partial u} \; \frac{\partial u }{ \partial h}    +  \frac{\partial F^{uvh}_h}{\partial v} \; \frac{\partial v }{ \partial h} + \frac{\partial F^{uvh}}{\partial h} \; \frac{\partial h }{ \partial h} = - \frac{\partial F^{uvh}_h }{ \partial h}  $$
%
% or
%
% $$
...
% \end{array} \right )
% = - \left ( \begin{array}{c}
%   \frac{\partial F^{uvh}_x}{\partial h} \\
%   \frac{\partial F^{uvh}_y}{\partial h} \\
%   \frac{\partial F^{uvh}_h}{\partial h}
%   \end{array} \right )
% $$
%
%
