...
function [KdudA,KdvdA,KdhdA,KdFuvhduvh]=duvhdA(CtrlVar,MUA,F,l,BCs,KdFuvhduvh,Nodes)
...
% then
%
% $$ \frac{\partial F^{uvh}_x}{\partial u} \; \frac{\partial u }{ \partial A}    +  \frac{\partial F^{uvh}_x}{\partial v} \; \frac{\partial v }{ \partial A} + \frac{\partial F^{uvh}_x}{\partial h} \; \frac{\partial h }{ \partial A} = - \frac{\partial F^{uvh}_x }{ \partial A}  $$
%
% $$ \frac{\partial F^{uvh}_y}{\partial u} \; \frac{\partial u }{ \partial A}    +  \frac{\partial F^{uvh}_y}{\partial v} \; \frac{\partial v }{ \partial A} + \frac{\partial F^{uvh}_y}{\partial h} \; \frac{\partial h }{ \partial A} = - \frac{\partial F^{uvh}_y }{ \partial A}  $$
%
% $$ \frac{\partial F^{uvh}_h}{\partial u} \; \frac{\partial u }{ \partial A}    +  \frac{\partial F^{uvh}_h}{\partial v} \; \frac{\partial v }{ \partial A} + \frac{\partial F^{uvh}}{\partial h} \; \frac{\partial h }{ \partial A} = - \frac{\partial F^{uvh}_h }{ \partial A}  $$
%
% or
%
% $$
...
% \end{array} \right )
% = - \left ( \begin{array}{c}
%   \frac{\partial F^{uvh}_x}{\partial A} \\
%   \frac{\partial F^{uvh}_y}{\partial A} \\
%   \frac{\partial F^{uvh}_h}{\partial A}
%   \end{array} \right )
% $$
%
%
...
KdFuvdA=dFuvdA(CtrlVar,MUA,F);  % this is sparse
KdFuvhdA=[KdFuvdA ; sparse(MUA.Nnodes,MUA.Nnodes)] ; 
...
KdudA=sol(1:MUA.Nnodes,:);
KdvdA=sol(MUA.Nnodes+1:2*MUA.Nnodes,:);
KdhdA=sol(2*MUA.Nnodes+1:3*MUA.Nnodes,:);
