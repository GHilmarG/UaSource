...
function [u,v,lambda,kv,rh]=...
	...
	%if n==1 && m==1 ; CtrlVar.NR=0; CtrlVar.Piccard=1; end

% 	
% 	if CtrlVar.Piccard==1
% 		[u,v,lambda,kv,rh,etaInt]=...
% 			SSTREAM2dPicard(s,S,h,u,v,coordinates,connectivity,Boundary,nip,etaInt,GF,AGlen,C,L,Lb,lambda,n,m,alpha,rho,rhow,g,Itime,CtrlVar);
% 	end
