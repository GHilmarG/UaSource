function [betaGrad]=betaGradient5(u,v,Lambda,Mu,C,connectivity,coordinates,nip);
    
    disp(' beta gradient 5 ')
    ...
    for Iele=1:Nele
        ...
        for Iint=1:nip                           % loop over integration points
            ...
            c11=c11- betaI*uI*(fun*fun')*detJw;
            c22=c22- betaI*vI*(fun*fun')*detJw;
    ...
    betaGrad=-2*[Lambda;Mu]'*[Bu;Bv]; betaGrad=betaGrad(:);
