...
function [UserVar,RunInfo,F1,F0,l0,l1,BCs1,dt]=uvh2NotConvergent(UserVar,RunInfo,CtrlVar,MUA,F0,F1,l0,l1,BCs1)
...
while CtrlVar.dt > dtMin
    ...
    F1.dt=CtrlVar.dt ;  F0.dt=CtrlVar.dt ; dt=CtrlVar.dt ;
