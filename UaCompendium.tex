...
\label{eq:ahA}
\end{equation}
%As we have already determined $u$ as a function of $h$ and $\p_x h$,
%this equation now gives us a relationship between the thickness ($h$),
%and the thickness gradient ($\p_x h$). (The boundary condition at the
%groudnding line allows us to express $\p_x u$ in terms of local thickness.) 
