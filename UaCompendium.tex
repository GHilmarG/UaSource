...
\subsection{Including the rate-of-elevation change in the cost function}

The rate-of-elevation change, $\p_t h$, can also be included in the cost function, leading to
...
\[
\delta_{uv} I_{\dot{h}}= \frac{1}{{\cal A}} \int \left ((u-u_{\mathrm{meas}})/u^2_{\mathrm{error}} \right )  \left ( \p_x ( h \delta u) + \p_y ( h \delta v) \right ) \, dx \, dy
\]
