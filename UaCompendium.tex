...
If we think of $S$, $B$, and $h$ as independent variables, $s$ and $b$ are given by
\begin{align}
...
\begin{enumerate}
\item The derivative of the forward model with respect to the state and control variables, i.e $\p_u F and $\p_p F$$
\item The derivative of the objective function with respect to the state an control variables, i.e.\ $\p_u J$ and $\p_p J$.
\end{enumerate}
...
\section{Gradients of objective functions with respect to field variables}
