...
if any(arrayfun(@(x) isequal(x.name,'F'),Contents))
    ...
    try
        ...
        F=Vars2UaFields(ub,vb,ud,vd,s,b,h,S,B,AGlen,C,m,n,rho,rhow,Co,mo,Ca,ma,as,ab,dasdh,dabdh,dhdt,dsdt,dbdt,dhdtm1,dubdt,dvbdt,dubdtm1,dvbdtm1,duddt,dvddt,duddtm1,dvddtm1,g,alpha);
